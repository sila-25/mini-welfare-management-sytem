...
// Check permission - only authorized roles can access accounts
                ...
                <div class="col-md-6">
                    <div class="card border-0 shadow-lg text-center">
                        <div class="card-body py-5">
                            ...
                            <p class="text-muted mb-4">You do not have permission to access the Accounts section.</p>
    ...
    <div class="container-fluid p-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 pt-3 pb-0">
                <h5 class="mb-0"><i class="fas fa-university me-2 text-info"></i>Accounts Management</h5>
            </div>
            <div class="card-body">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    Accounts module is under construction. Check back soon!
                </div>
            </div>
        </div>
    </div>
